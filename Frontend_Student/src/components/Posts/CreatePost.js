              ...
              <div className='flex'>
                <div className='mt-1'>
                  ...
                  <input
                    ...
                    onChange={formik.handleChange('minutes')}
                    onBlur={formik.handleBlur('minutes')}
                    id='minutes'
                    placeholder='Min'
                    name='minutes'
                    type='number'
                ...
                <div className='mt-1'>
                  <input
                    ...
                    onChange={formik.handleChange('hour')}
                ...
                {/* Err msg */}
                {/* <div className='text-red-500'>
                  {formik?.touched?.title && formik?.errors?.date}
                </div> */}

                {/* Err msg */}
                {/* <div className='text-red-500'>
                  {formik?.touched?.title && formik?.errors?.month}
                </div> */}
                <div className='mt-1'>
                  {/* Title */}
                  <input
                ...
                <div className='mt-1'>
                  ...
                  <input
                    ...
                    onChange={formik.handleChange('dayofweek')}
